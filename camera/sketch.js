...
var palette = [color(255, 239, 214), color(59, 55, 44), color(255, 255, 255), color(0, 0, 0), color(204, 91, 10)];

noStroke();


var drawCamera = function(xPos, yPos, scale) {
    //camera body
    fill(palette[0]);
...
var drawPhoto = function(xPos, yPos, yScale) {
    fill(palette[2]);
